...
public class Estancia {
    ...
    public Estancia(int id_estancia, Cliente cliente, int id_casa, String nombre_huesped, Date fecha_desde, Date fecha_hasta) {
    ...
    public String toString() {
        return "Estancia{" + "id_estancia=" + id_estancia + ", id_cliente=" + cliente + ", id_casa=" + casa + ", nombre_huesped=" + nombre_huesped + ", fecha_desde=" + fecha_desde + ", fecha_hasta=" + fecha_hasta + '}';
    }
